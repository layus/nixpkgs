...
, gzip, openssh, pcre2, glibc
, asciidoc, texinfo, xmlto, docbook2x, docbook_xsl, docbook_xml_dtd_45
, libxslt, tcl, tk, makeWrapper, libiconv, sparse
...
stdenv.mkDerivation {
  ...
  buildInputs = [curl openssl zlib expat gettext cpio makeWrapper libiconv perl sparse glibc]
